...
def main():
    ...
    parser.add_argument("-e", "--extension", type=str, help="Only files with this extension will be archived", required=False);
    ...
    for filename in glob.iglob(os.path.join(args.inputdirectory, '*' if not args.extension else ('*.' + args.extension))):
